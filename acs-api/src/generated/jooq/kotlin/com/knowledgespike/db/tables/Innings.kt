...
open class Innings(
    ...
    val matches: MatchesPath by lazy { MatchesPath(this, INNINGS_IBFK_1, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Teams</code>
     * table, via the <code>innings_ibfk_2</code> key.
     */
    fun inningsIbfk_2(): TeamsPath = inningsIbfk_2
    val inningsIbfk_2: TeamsPath by lazy { TeamsPath(this, INNINGS_IBFK_2, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Teams</code>
     * table, via the <code>innings_ibfk_3</code> key.
     */
    fun inningsIbfk_3(): TeamsPath = inningsIbfk_3
    val inningsIbfk_3: TeamsPath by lazy { TeamsPath(this, INNINGS_IBFK_3, null) }
