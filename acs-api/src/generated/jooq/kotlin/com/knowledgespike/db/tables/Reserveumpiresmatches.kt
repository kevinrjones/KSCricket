...
open class Reserveumpiresmatches(
     ...
     */
    fun reserveumpires(): ReserveumpiresPath = reserveumpires
    val reserveumpires: ReserveumpiresPath by lazy { ReserveumpiresPath(this, RESERVEUMPIRESMATCHES_IBFK_1, null) }
    ...
    val matches: MatchesPath by lazy { MatchesPath(this, RESERVEUMPIRESMATCHES_IBFK_2, null) }
