...
open class Extramatchdetails(
     ...
     */
    fun extramatchdetailsIbfk_1(): TeamsPath = extramatchdetailsIbfk_1
    val extramatchdetailsIbfk_1: TeamsPath by lazy { TeamsPath(this, EXTRAMATCHDETAILS_IBFK_1, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Teams</code>
     * table, via the <code>extramatchdetails_ibfk_2</code> key.
     */
    fun extramatchdetailsIbfk_2(): TeamsPath = extramatchdetailsIbfk_2
    val extramatchdetailsIbfk_2: TeamsPath by lazy { TeamsPath(this, EXTRAMATCHDETAILS_IBFK_2, null) }
    ...
    val matches: MatchesPath by lazy { MatchesPath(this, EXTRAMATCHDETAILS_IBFK_3, null) }
