...
open class Partnerships(
    ...
    val matches: MatchesPath by lazy { MatchesPath(this, PARTNERSHIPS_IBFK_1, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Teams</code>
     * table, via the <code>partnerships_ibfk_2</code> key.
     */
    fun partnershipsIbfk_2(): TeamsPath = partnershipsIbfk_2
    val partnershipsIbfk_2: TeamsPath by lazy { TeamsPath(this, PARTNERSHIPS_IBFK_2, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Teams</code>
     * table, via the <code>partnerships_ibfk_3</code> key.
     */
    fun partnershipsIbfk_3(): TeamsPath = partnershipsIbfk_3
    val partnershipsIbfk_3: TeamsPath by lazy { TeamsPath(this, PARTNERSHIPS_IBFK_3, null) }
