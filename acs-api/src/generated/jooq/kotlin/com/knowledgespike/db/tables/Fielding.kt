...
open class Fielding(
    ...
    val matches: MatchesPath by lazy { MatchesPath(this, FIELDING_IBFK_1, null) }
    ...
    val players: PlayersPath by lazy { PlayersPath(this, FIELDING_IBFK_2, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Teams</code>
     * table, via the <code>fielding_ibfk_3</code> key.
     */
    fun fieldingIbfk_3(): TeamsPath = fieldingIbfk_3
    val fieldingIbfk_3: TeamsPath by lazy { TeamsPath(this, FIELDING_IBFK_3, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Teams</code>
     * table, via the <code>fielding_ibfk_4</code> key.
     */
    fun fieldingIbfk_4(): TeamsPath = fieldingIbfk_4
    val fieldingIbfk_4: TeamsPath by lazy { TeamsPath(this, FIELDING_IBFK_4, null) }
