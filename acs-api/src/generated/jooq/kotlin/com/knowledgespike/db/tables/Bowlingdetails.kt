...
open class Bowlingdetails(
    ...
    val matches: MatchesPath by lazy { MatchesPath(this, BOWLINGDETAILS_IBFK_1, null) }
    ...
    val players: PlayersPath by lazy { PlayersPath(this, BOWLINGDETAILS_IBFK_2, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Teams</code>
     * table, via the <code>bowlingdetails_ibfk_3</code> key.
     */
    fun bowlingdetailsIbfk_3(): TeamsPath = bowlingdetailsIbfk_3
    val bowlingdetailsIbfk_3: TeamsPath by lazy { TeamsPath(this, BOWLINGDETAILS_IBFK_3, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Teams</code>
     * table, via the <code>bowlingdetails_ibfk_4</code> key.
     */
    fun bowlingdetailsIbfk_4(): TeamsPath = bowlingdetailsIbfk_4
    val bowlingdetailsIbfk_4: TeamsPath by lazy { TeamsPath(this, BOWLINGDETAILS_IBFK_4, null) }
    ...
    val grounds: GroundsPath by lazy { GroundsPath(this, BOWLINGDETAILS_IBFK_5, null) }
