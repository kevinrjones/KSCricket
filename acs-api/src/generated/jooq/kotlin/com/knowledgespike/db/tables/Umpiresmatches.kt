...
open class Umpiresmatches(
     ...
     * table.
     */
    fun umpires(): UmpiresPath = umpires
    val umpires: UmpiresPath by lazy { UmpiresPath(this, UMPIRESMATCHES_IBFK_1, null) }
    ...
    val matches: MatchesPath by lazy { MatchesPath(this, UMPIRESMATCHES_IBFK_2, null) }
