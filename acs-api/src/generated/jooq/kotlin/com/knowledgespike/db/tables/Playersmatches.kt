...
open class Playersmatches(
    ...
    val players: PlayersPath by lazy { PlayersPath(this, PLAYERSMATCHES_IBFK_1, null) }
    ...
    val matches: MatchesPath by lazy { MatchesPath(this, PLAYERSMATCHES_IBFK_2, null) }
