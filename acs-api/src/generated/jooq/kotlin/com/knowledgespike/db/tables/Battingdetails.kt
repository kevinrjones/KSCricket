...
open class Battingdetails(
    ...
    val matches: MatchesPath by lazy { MatchesPath(this, BATTINGDETAILS_IBFK_1, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Players</code>
     * table, via the <code>battingdetails_ibfk_2</code> key.
     */
    fun battingdetailsIbfk_2(): PlayersPath = battingdetailsIbfk_2
    val battingdetailsIbfk_2: PlayersPath by lazy { PlayersPath(this, BATTINGDETAILS_IBFK_2, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Players</code>
     * table, via the <code>battingdetails_ibfk_3</code> key.
     */
    fun battingdetailsIbfk_3(): PlayersPath = battingdetailsIbfk_3
    val battingdetailsIbfk_3: PlayersPath by lazy { PlayersPath(this, BATTINGDETAILS_IBFK_3, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Teams</code>
     * table.
     */
    fun teams(): TeamsPath = teams
    val teams: TeamsPath by lazy { TeamsPath(this, BATTINGDETAILS_IBFK_4, null) }
    ...
    val grounds: GroundsPath by lazy { GroundsPath(this, BATTINGDETAILS_IBFK_5, null) }
