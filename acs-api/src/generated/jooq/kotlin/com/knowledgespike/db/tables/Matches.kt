...
open class Matches(
    ...
    /**
     * The column <code>cricketarchive.Matches.MatchEndDate</code>.
     */
    val MATCHENDDATE: TableField<MatchesRecord, LocalDate?> = createField(DSL.name("MatchEndDate"), SQLDataType.LOCALDATE.defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.LOCALDATE)), this, "")

    /**
     * The column <code>cricketarchive.Matches.MatchEndDateAsOffset</code>.
     */
    val MATCHENDDATEASOFFSET: TableField<MatchesRecord, Long?> = createField(DSL.name("MatchEndDateAsOffset"), SQLDataType.BIGINT.defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.BIGINT)), this, "")
    ...
    override fun getReferences(): List<ForeignKey<MatchesRecord, *>> = listOf(MATCHES_IBFK_1, MATCHES_IBFK_2, MATCHES_IBFK_3, MATCHES_IBFK_4, MATCHES_IBFK_5, MATCHES_IBFK_6)

    /**
     * Get the implicit join path to the <code>cricketarchive.Teams</code>
     * table, via the <code>matches_ibfk_1</code> key.
     */
    fun matchesIbfk_1(): TeamsPath = matchesIbfk_1
    val matchesIbfk_1: TeamsPath by lazy { TeamsPath(this, MATCHES_IBFK_1, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Teams</code>
     * table, via the <code>matches_ibfk_2</code> key.
     */
    fun matchesIbfk_2(): TeamsPath = matchesIbfk_2
    val matchesIbfk_2: TeamsPath by lazy { TeamsPath(this, MATCHES_IBFK_2, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Teams</code>
     * table, via the <code>matches_ibfk_3</code> key.
     */
    fun matchesIbfk_3(): TeamsPath = matchesIbfk_3
    val matchesIbfk_3: TeamsPath by lazy { TeamsPath(this, MATCHES_IBFK_3, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Teams</code>
     * table, via the <code>matches_ibfk_4</code> key.
     */
    fun matchesIbfk_4(): TeamsPath = matchesIbfk_4
    val matchesIbfk_4: TeamsPath by lazy { TeamsPath(this, MATCHES_IBFK_4, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Teams</code>
     * table, via the <code>matches_ibfk_5</code> key.
     */
    fun matchesIbfk_5(): TeamsPath = matchesIbfk_5
    val matchesIbfk_5: TeamsPath by lazy { TeamsPath(this, MATCHES_IBFK_5, null) }

    /**
     * Get the implicit join path to the <code>cricketarchive.Grounds</code>
     * table.
     */
    fun grounds(): GroundsPath = grounds
    val grounds: GroundsPath by lazy { GroundsPath(this, MATCHES_IBFK_6, null) }
