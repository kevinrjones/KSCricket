 ...
 */
object JooqBattingIndividualSeries {
        ...
        val cte =
            select(
                ...
                select(
                    ...
                    field("${tmpBattingDetailsName}.seriesdate", String::class.java).`as`("year"),
                    field("${tmpBattingDetailsName}.seriesNumber"),
                    computedBalls(),
                    ...
                    .and(searchCondition)
                    .and(field("${tempMatchCountsName}.seriesnumber", Int::class.java).eq(field("${tmpBattingDetailsName}.Seriesnumber", Int::class.java)))
                    .and(field("${tempMatchCountsName}.seriesdate", String::class.java).eq(field("${tmpBattingDetailsName}.Seriesdate", String::class.java)))
                    .groupBy(field("matchtype"), field("playerid"), field("${tmpBattingDetailsName}.seriesnumber"), field("${tmpBattingDetailsName}.seriesdate"))
                    .asTable("innings")
