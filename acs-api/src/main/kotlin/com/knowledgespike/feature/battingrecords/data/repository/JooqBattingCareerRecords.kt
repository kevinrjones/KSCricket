...
/**
 * An object containing methods to compute and manage cricket batting career statistics
 ...
 * for gaining insights into batting performances.
 */
        ...
        val cte =
            select(
                ...
                select(
                    ...
                    .on(EXTRAMATCHDETAILS.MATCHID.eq(field("${tmpBattingDetailsName}.matchid", Int::class.java)))
                    .and(EXTRAMATCHDETAILS.TEAMID.eq(field("${tmpBattingDetailsName}.teamid", Int::class.java)))
                    .and(searchCondition)
