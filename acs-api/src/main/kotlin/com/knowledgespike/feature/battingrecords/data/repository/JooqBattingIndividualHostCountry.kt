...
import com.knowledgespike.db.tables.Countries.Companion.COUNTRIES
 ...
 */
object JooqBattingIndividualHostCountry {

    /**
     * Creates a Common Table Expression (CTE) query to retrieve detailed batting statistics
     * using the provided search parameters and temporary table names.
     *
     * The query incorporates various conditions, computed fields, and aggregations, such as average,
     * strike rate, and batting index, to generate a refined dataset for analysis.
     *
     * @param searchParameters The validated search parameters containing filters, match types,
     *                          sorting options, and paging configurations.
     * @param tmpBattingDetailsName The name of the temporary table storing batting details.
     * @param tempTeamsName The name of the temporary table containing team information.
     * @return A `SelectJoinStep` that represents the CTE query to generate detailed batting statistics records.
     */
    ...
    ): SelectJoinStep<Record22<Int?, String?, String?, Int, Int, Int, Int, Int, Int, Double, Int, Int, Int, Int, Int, Int, String, String, Double, Double, BigDecimal, String?>> {
        ...
        val cte =
            select(
                ...
                select(
                    ...
                    field("${tmpBattingDetailsName}.homeCountryId"),
                    ...
                    .and(field("${tempMatchCountsName}.homeCountryId", Int::class.java).eq(field("${tmpBattingDetailsName}.homeCountryId", Int::class.java)))
                    ...
                    .and(searchCondition)
                    .groupBy(field("matchtype"), field("playerid"), field("${tmpBattingDetailsName}.homeCountryId"))
                    .asTable("innings")
