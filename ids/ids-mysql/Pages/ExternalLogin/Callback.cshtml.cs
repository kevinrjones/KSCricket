...
namespace ids_mysql.Pages.ExternalLogin;
...
public class Callback : PageModel
{
    ...
    public async Task<IActionResult> OnGet()
    {
        ...
        if (user == null)
        {
            ...
            var lastName = externalUser.FindFirstValue(ClaimTypes.Surname) ?? "";
            
            user = new ApplicationUser(Guid.NewGuid().ToString()) { Email = email, FirstName = givenName, LastName = lastName};
