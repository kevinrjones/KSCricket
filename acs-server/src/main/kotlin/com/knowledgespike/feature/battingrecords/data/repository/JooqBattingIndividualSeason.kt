 ...
 */
object JooqBattingIndividualSeason {
        ...
        val cte =
            select(
                ...
                select(
                    ...
                    .and(field("${tempMatchCountsName}.SeriesDate", Int::class.java).eq(field("${tmpBattingDetailsName}.SeriesDate", Int::class.java)))
                    ...
                    .and(searchCondition)
                    .groupBy(field("matchtype"), field("playerid"), field("${tmpBattingDetailsName}.seriesdate"))
                    .asTable("innings")
                    ...
                    .and(field("${tempTeamsName}.seriesDate", Int::class.java).eq(field("innings.year", Int::class.java)))
