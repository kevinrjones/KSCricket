...
@Component({
    selector: 'app-team-overallextras-ui',
    templateUrl: './team-overallextras-ui.component.html',
    styleUrls: ['./team-overallextras-ui.component.css'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone: false
})
export class TeamOverallExtrasUiComponent implements OnInit {

  @Input() teamUIModel$!: Observable<OverallExtrasUiModel>;
  @Input() title!: string;
  ...
  getMatchLink(row: OverallExtrasDto) {
