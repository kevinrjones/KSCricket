...
@Component({
    selector: 'app-team-target-ui',
    templateUrl: './team-target-ui.component.html',
    styleUrls: ['./team-target-ui.component.css'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone: false
})
export class TeamTargetUiComponent implements OnInit {

  @Input() teamUIModel$!: Observable<ByTargetUiModel>;
  @Input() title!: string;
  @Input() targetColumnTitle!: string;
